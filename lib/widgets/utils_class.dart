...
import 'package:myapp/calories/edit_meal.dart';
...
class TextFormFieldWidget_ extends StatelessWidget {
  final double fem;
  final String hintText;
  final TextInputType keyboardType;
  final bool obscureText;
  const TextFormFieldWidget_({
    super.key,
    required this.fem,
    required this.hintText,
    required this.keyboardType,
...
class MainAppBar2 extends StatelessWidget with PreferredSizeWidget {
  final String title;
  const MainAppBar2({
    super.key,
    required this.title,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Icon(Icons.arrow_forward_ios,
                          color: Color(0xFFE00700), size: 14)
                    ],
                  ),
                ],
              ),
