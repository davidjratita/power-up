...
class EditWorkoutRoutine extends StatefulWidget {
  @override
  State<EditWorkoutRoutine> createState() => _EditWorkoutRoutineState();
}

class _EditWorkoutRoutineState extends State<EditWorkoutRoutine> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: MainAppBar2(title: 'Edit routine'),
      body: ListView(
